      ...
      <div className="ml-auto">
        ...
        <form action="" className="my-10" onSubmit={handleSubmit}>
            <div className="flex flex-col space-y-5">
                ...
                <p className="text-center">  Need an account? <Link to='/signup'>Sign up</Link><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
